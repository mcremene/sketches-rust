...
fn test_sketch_create() {
    let mut sketch1: DDSketch = DDSketch::collapsing_lowest_dense(2e-2, 100).unwrap();
    sketch1.accept(1.0);
    let mut sketch2: DDSketch = DDSketch::collapsing_highest_dense(2e-2, 100).unwrap();
    sketch2.accept(1.0);
    let mut sketch3: DDSketch = DDSketch::logarithmic_collapsing_lowest_dense(2e-2, 100).unwrap();
    sketch3.accept(1.0);
    let mut sketch4: DDSketch = DDSketch::logarithmic_collapsing_highest_dense(2e-2, 100).unwrap();
    sketch4.accept(1.0);
    let mut sketch5: DDSketch = DDSketch::unbounded_dense(2e-2).unwrap();
    sketch5.accept(1.0);
    let mut sketch6: DDSketch = DDSketch::logarithmic_unbounded_size_dense_store(2e-2).unwrap();
    sketch6.accept(1.0);
}
